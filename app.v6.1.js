...
// ---- INIT & LOADING ----
state.planets = (PLANETS_EMBED.planets||[]);
initAfterData();
overlay.style.display='none'; ovText.textContent='';
console.log('%cSTAR WARS v5.3','background:#032;padding:2px 6px;border-radius:4px;color:#9ff', 'ready with embedded data');
// live coords readout// live coords readout
